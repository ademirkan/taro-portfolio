...
import RenderOnceInView from "./RenderOnceInView";
...
const WorkSection: React.FC = () => {
    ...
    return (
        <section
            id="projects-section"
            className="w-[100%] text-primary overflow-hidden"
        >
            <ol
                className={`${subtitleFont.className} flex flex-col ${
            ...
            >
                ...
                >
                    <div className="md:w-[50%] w-[100%] pb-16 pt-32 flex flex-col items-center md:pl-16">
                        <ExperienceCard
                        ...
                        >
                            ...
                            >
                                <li>
                                    Expanded UI library for #1 typing site with
                                    ~2 million users
                                </li>
                                <li>
                                    Independently launched fluid highlighting
                                    feature, now serving ~120,000 users daily
                                </li>
                                <li>
                                    Proposed several UI improvements to
                                    leadership, developed and implemented in
                                    pull requests
                                </li>
                                <li>
                                    Improved animation frame rate by ~52% in
                                    core component
                                </li>
                                <li>
                                    Optimized legacy component, reducing jQuery
                                    calls by ~99% and DOM manipulations by ~96%
                                </li>
                            </ul>
                        </ExperienceCard>
                    </div>
                    {!isMobile && (
                        <div className="vignetteContainer w-[50%] z-50">
                            <div className="vignette drop-shadow-[-7px_7px_20px_rgba(30,30,34,30)]">
                                <RenderOnceInView
                                    once={false}
                                    margins="0px 0px -500px 0px"
                                >
                                    <FadeIn initialOffset={10} axis="x">
                                        <Image
                ...
                >
                    <div className="md:w-[50%] w-[100%] pb-16 pt-16 flex flex-col items-center md:pl-16">
                        ...
                        >
                            ...
                            >
                                <li>
                                    Expanded UI library for ed-tech startup
                                ...
                                <li>
                                    Designed and implemented several core UI
                                    components to support product launch
                                </li>
                                <li>
                    ...
                    {!isMobile && (
                        <div className="vignetteContainer w-[50%]">
                        ...
                        >
                            ...
                            >
                                <li>
                                    ...
                                    to build internal tools using Python
                                </li>
                                <li>
                                    Developed scraper to parse rankings of ~1500
                                    universities
                                </li>
                                <li>
                                    Created internal tool to automate updating
                                    school ranks in database, saving 100+ hours
                                    of data entry
                                </li>
                            </ul>
                        </ExperienceCard>
                ...
                >
                    <div className="md:w-[50%] w-[100%] pb-16 pt-16 flex flex-col items-center md:pl-16">
                        ...
                        >
                            ...
                            >
                                An opensource URL shortener built for the modern
                                web. Shorten your links with ease and track
                                analytics such as clickrate, regional
                                demographics, device types, etc.
                            </span>
                        </ExperienceCard>
                    </div>
                    {!isMobile && (
                    ...
                    <div className="md:w-[50%] w-[100%] pb-16 pt-16 flex flex-col items-center md:pl-16">
                        ...
                        >
                            <span
                                className={`text-sm my-2 ${bulletFont.className} text-secondary`}
                            >
                                Productivity web app that allows users to sync
                                study sessions with their friends. Configure
                                your study/break sessions, share a link to your
                                friends, and study together.
                            </span>
                        </ExperienceCard>
                    </div>
                    {!isMobile && (
                    ...
                    <div className="md:w-[50%] w-[100%] pb-16 pt-16 flex flex-col items-center md:pl-16">
                        ...
                        >
                            <span
                                className={`text-sm my-2 ${bulletFont.className} text-secondary`}
                            >
                                A web app that allows users to find familiar
                                faces from previous classes. On the first day of
                                class, students turn on the search mode. The app
                                then searches for other devices, sorts students
                                by past mutual classes.
                            </span>
                        </ExperienceCard>
                    </div>
                    {!isMobile && (
